...
|---------|-------|-------------|
| [Chapter 1](./chapter-01/README.md) | Deploy Your First Foundry Agent | Create a simple Q&A agent using the `azure-ai-projects` SDK. Provisions an AI Hub and AI Project via Bicep IaC, then creates the agent inline with `AIProjectClient` and starts an interactive CLI chat. |
